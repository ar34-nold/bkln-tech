...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        parent, _ = CourseCategory.objects.get_or_create(name="Developpement Web", slug="developpement-web")
        Course.objects.get_or_create(
            slug="django-5-api-rest",
            defaults={"category": parent, "trainer": admin, "title": "Django 5 et API REST", "description": "Construire une application web complete avec Django, Bootstrap et API REST.", "price": 75000, "published": True},
        )
        blog_category, _ = BlogCategory.objects.get_or_create(name="Actualites", slug="actualites")
